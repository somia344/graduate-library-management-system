        ...
        <div class="col-md-6 col-lg-5" data-aos="fade-up">
            <div class="card border-0 shadow-lg rounded-4">
                <div class="card-header bg-transparent text-center pt-4 pb-0 border-0">
                    ...
                    <h3 class="fw-bold" style="color: #0D5C63;">Librarian Login</h3>
                    <p class="text-muted" style="color: #6B7280;">Welcome back! Please login to your account</p>
                </div>
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('librarian.login.submit') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control border-start-0 ps-2" 
                                       placeholder="librarian@example.com" required value="{{ old('email') }}">
                            </div>
                        </div>
                        ...
                        <div class="mb-4 d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('librarian.forgot') }}" class="text-decoration-none" style="color: #0D5C63;">
                                </i>Forgot Password?
                            </a>
                        </div>
